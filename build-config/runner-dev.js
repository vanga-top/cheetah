...
const rendererCheetahConfig = require('./renderer-cheetah/webpack.config.dev')
...
function startRendererCheetah() {
    return new Promise((resolve, reject) => {
        // rendererConfig.entry.renderer = [path.join(__dirname, 'dev-client')].concat(rendererConfig.entry.renderer)
        // rendererConfig.mode = 'development'
        const compiler = webpack(rendererCheetahConfig)
...
function init() {
    ...
    spinners.add('renderer-cheetah', { text: 'renderer-cheetah compiling' })
    ...
    Promise.all([
      ...
      startRendererCheetah().then(() => handleSuccess('renderer-cheetah')).catch((err) => {
        console.error(err.message)
        return handleFail('renderer-cheetah')
      }),
